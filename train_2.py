...
####### Save data into file ###
#savetxt('new_array_x_train_data.csv', X_train, delimiter=',')
#savetxt('new_array_x_vali_data.csv', X_vali, delimiter=',')
#savetxt('new_array_x_test_data.csv', X_test, delimiter=',')
...
model = Sequential() #private_08
model.add(Dense(224, input_shape=(386,), activation = 'relu'))
...
# Set title
plt.title('private_08', fontsize = 25)
...
# ###
# Zalo_public_test.to_csv('private_02.csv')
