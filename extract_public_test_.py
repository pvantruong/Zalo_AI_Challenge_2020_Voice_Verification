...
def extract_features(files):
    ...
    file_name = os.path.join(os.path.abspath('temp')+'/'+str(files.file))
...
##### Zalo ##################
train_features = test_df.apply(extract_features, axis=1)
print('Zalo_file_features: ')
...
# savetxt('Exampleee_data_1.csv', X_test_1, delimiter=',')
# savetxt('Exampleee_data_2.csv', X_test_2, delimiter=',')